...
Available Operators:
"NOT:" before a string will search for all decks that do not contain that string. For example, "NOT:Book of Moon" will search for all decks without Book of Moon. "NOT:Book of" will search for all decks without any card that contains the text "Book of".<br />
"# " before a string will search for decks that contain that exact number of copies of a card that must be spelled out completely. For example, "2 Book of Moon" will find decks that contain exactly two copies of Book of Moon.<br />
